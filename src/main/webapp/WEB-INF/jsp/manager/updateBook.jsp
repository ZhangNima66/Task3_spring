    ...
    <div class="col-sm-offset-3 col-sm-6 col-sm-offset-3" style="margin-top: 100px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">更新书籍信息</h3>
            </div>
                ...
                <form id="form_add" class="form-horizontal" role="form" style="margin: 0"
                    ...
                    <div class="form-group" style="margin: 0 -15px 0">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-default" style="width: 100px">修改</button>
                            <a class="btn btn-default" href="${pageContext.request.contextPath}/manager/listBook">取消</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <form action="${pageContext.request.contextPath }/manager/update"
        ...
        <table border="1">
            ...
            <tr>
                <td>图片</td>
                <td>
                    <img src="/upload/${book.image}" style="width: 83px; height: 115px"><br/>
                    <input type="hidden" name="image" value="${book.image}">
                    <input type="file" name="image_pic" style="width: 200px">
                </td>
            </tr>
            <tr>
                <td>描述</td>
            ...
            <tr>
                ...
                <td><select name="categoryId">
                    <c:forEach var="category" items="${categoryAll}">
                        <option value="${category.id }" ${book.categoryId==category.id?'selected = "selected"':''}>${category.name }</option>
                    </c:forEach>
                </select></td>
            </tr>
            <tr>
